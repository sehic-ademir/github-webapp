    ...
    render() { 
        ...
        return ( 
            ...
            <form className="col-lg-4 mx-auto mx-md-0 ml-md-auto offset-md-4 col-12 row text-center" >
			    ...
			    <input type="text" id="searchUser" className="form-control col-lg-5 col-12 ml-1 mx-auto my-2 my-lg-0"  placeholder={"Search " + searchPrefix} value={searchValue} name="search" onChange={this.handleChange} required />
                <Link className="col-lg-2 col-12 ml-md-1 my-2 my-md-0 no-bg"  to={isValidSearch ? `/${searchPrefix}/${searchValue}/1` : ''}><button className="btn btn-light">Search</button></Link>
		    </form>
            </div>
         );
    }
